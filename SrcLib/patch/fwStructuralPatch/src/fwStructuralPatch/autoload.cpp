...
struct runner
{
    runner()
    {
        ...
        structuralPatches->registerPatch(::fwStructuralPatch::fwData::Material::V4ToV5::New());
        structuralPatches->registerPatch(::fwStructuralPatch::fwData::Material::V5ToV4::New());
