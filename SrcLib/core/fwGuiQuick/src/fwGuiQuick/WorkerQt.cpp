...
protected:
    ...
    QPointer< ::fwGuiQuick::util::FuncSlot > m_qtFunc;
};
...
void WorkerQt::init( int& argc, char** argv, bool guiEnabled )
{
    ...
    m_argc = argc;
    m_app  = QSharedPointer< QApplication > ( new ::fwGuiQuick::App( m_argc, argv, guiEnabled ) );
...
{
    QApplication::sendPostedEvents(0, ::fwGuiQuick::WorkerQtTask::s_WORKER_QT_TASK_EVENT_TYPE);
}
...
{
    m_qtFunc = new ::fwGuiQuick::util::FuncSlot();
