...
#include "fwGuiQuick/SliceSelector.hpp"
...
SliceSelector::SliceSelector(QWidget* const parent ) throw() :
    QWidget( parent )
{
    m_fctChangeIndexCallback = std::bind( &::fwGuiQuick::SliceSelector::printIndex, this, std::placeholders:: _1);
    m_fctChangeTypeCallback  = std::bind( &::fwGuiQuick::SliceSelector::printType, this, std::placeholders:: _1);
