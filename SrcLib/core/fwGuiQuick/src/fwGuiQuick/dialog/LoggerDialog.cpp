...
#include "fwGuiQuick/dialog/LoggerDialog.hpp"
...
fwGuiRegisterMacro( ::fwGuiQuick::dialog::LoggerDialog, ::fwGui::dialog::ILoggerDialog::REGISTRY_KEY );
...
bool LoggerDialog::show()
{
    ...
    {
        iconLabel->setPixmap(QIcon("share/fwGuiQuick_0-1/critical.png").pixmap(48, 48));
    }
    else if(m_logger->count(::fwLog::Log::WARNING) > 0)
    {
        iconLabel->setPixmap(QIcon("share/fwGuiQuick_0-1/warning.png").pixmap(48, 48));
    }
    else
    {
        iconLabel->setPixmap(QIcon("share/fwGuiQuick_0-1/information.png").pixmap(48, 48));
    }
    ...
    checkbox->setStyleSheet("QCheckBox::indicator:unchecked { image: url(share/fwGuiQuick_0-1/details-hidden.png); } "
                            "QCheckBox::indicator:checked { image: url(share/fwGuiQuick_0-1/details-shown.png); }");
    ...
    for(; it != m_logger->end(); ++it, ++row)
    {
        ...
        if (level == ::fwLog::Log::INFORMATION)
        {
            ...
            levelIcon   = QIcon("share/fwGuiQuick_0-1/information.png");
        }
        else if (level == ::fwLog::Log::WARNING)
        {
            levelString = "Warning";
            levelIcon   = QIcon("share/fwGuiQuick_0-1/warning.png");
        }
        else if (level == ::fwLog::Log::CRITICAL)
        {
            levelString = "Critical";
            levelIcon   = QIcon("share/fwGuiQuick_0-1/critical.png");
        }
