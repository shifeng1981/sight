...
#include "fwGuiQuick/dialog/PulseProgressDialog.hpp"
...
fwGuiRegisterMacro(::fwGuiQuick::dialog::PulseProgressDialog, ::fwGui::dialog::IPulseProgressDialog::REGISTRY_KEY );
