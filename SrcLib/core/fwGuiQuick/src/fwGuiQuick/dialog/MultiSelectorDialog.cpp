...
#include "fwGuiQuick/dialog/MultiSelectorDialog.hpp"
...
fwGuiRegisterMacro( ::fwGuiQuick::dialog::MultiSelectorDialog, ::fwGui::dialog::IMultiSelectorDialog::REGISTRY_KEY );
