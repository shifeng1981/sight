...
//Workaround the a bug in the demangling function of NDK r14b (see: https://github.com/android-ndk/ndk/issues/355)
#ifdef ANDROID
    m_name(strcmp(t.name(), "_Z") == 0 || strcmp(t.name(), "__Z") == 0 ? t.name() : std::string("_Z") + t.name())
#else
    m_name(t.name())
#endif
{
