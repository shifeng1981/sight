...
::fwServices::IService::sptr AppConfigManager::getNewService(const std::string& uid, const std::string& implType) const
{
...
::fwServices::IService::sptr AppConfigManager::createService(const ::fwServices::IService::Config& srvConfig)
{
