...
public:
    ...
    FWRENDERVTK_QT_API SQRender::RendererIdType getRendererId() const;

    /// Returns the renderer
    FWRENDERVTK_QT_API vtkRenderer* getRenderer();

    /// Sets the identifier of the picker used by this adaptor
    FWRENDERVTK_QT_API void setPickerId(SQRender::PickerIdType newID);

    /// Gets the identifier of the picker used by this adaptor
    FWRENDERVTK_QT_API SQRender::PickerIdType getPickerId() const;
     ...
     */
    FWRENDERVTK_QT_API vtkAbstractPropPicker* getPicker(std::string pickerId = "");

    /// Sets the identifier of the transform used by this adaptor
    FWRENDERVTK_QT_API void setTransformId(SQRender::VtkObjectIdType newID);

    /// Returns the identifier of the transform used by this adaptor
    FWRENDERVTK_QT_API SQRender::VtkObjectIdType getTransformId() const;

    /// Returns the transform used by this adaptor
    FWRENDERVTK_QT_API vtkTransform* getTransform();

    /// Returns the vtk object defined by 'objectId' in the vtk scene
    FWRENDERVTK_QT_API vtkObject* getVtkObject(const SQRender::VtkObjectIdType& objectId) const;

    /// Returns the render interactor
    FWRENDERVTK_QT_API vtkRenderWindowInteractor* getInteractor();
...
protected:
     ...
     * @brief   constructor
     */
    FWRENDERVTK_QT_API IQAdaptor() noexcept;

    /**
     * @brief   destructor
     */
    FWRENDERVTK_QT_API virtual ~IQAdaptor() noexcept;

    /// Parse the xml configuration for renderer, picker and transform
    FWRENDERVTK_QT_API void configureParams();

    /// Initialize the adaptor with the associated render service. (must be call in starting).
    FWRENDERVTK_QT_API void initialize();

    /// Registers the vtkProp
    FWRENDERVTK_QT_API void registerProp(vtkProp* prop);

    /// Unregisters all the vtkProp
    FWRENDERVTK_QT_API void unregisterProps();

    /// Adds the vtkProp to the renderer
    FWRENDERVTK_QT_API void addToRenderer(vtkProp* prop);

    /// Removes all the vtkProp from the renderer
    FWRENDERVTK_QT_API void removeAllPropFromRenderer();
     ...
     */
    FWRENDERVTK_QT_API void addToPicker(vtkProp* prop, std::string pickerId = "");
     ...
     * @param pickerId picker identifier in the scene (if empty the current adaptor picker is used)
     */
    FWRENDERVTK_QT_API void removeFromPicker(vtkProp* prop, std::string pickerId = "");
     ...
     * @param[in] inProp
     */
    FWRENDERVTK_QT_API static void getProps(vtkPropCollection* outPropc, vtkProp* inProp);

    /// notify a render request iff vtkPipeline is modified
    FWRENDERVTK_QT_API void requestRender();
